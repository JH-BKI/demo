import{d as T,E as m}from"./index-Ba2CvrU_.js";let o=null,a=0,i=0,u=0,s=0,r=!1,t=null;const d=2e3,n=5;function D(){if(r){console.warn("[debugTouchArea.js]: [N/A] - [initDebugTouchArea] - Debug touch area already initialized.");return}o=document.createElement("div"),o.id="debugTouchArea",o.style.cssText=`
        position: fixed;
        top: 0;
        right: 0;
        width: 65px;
