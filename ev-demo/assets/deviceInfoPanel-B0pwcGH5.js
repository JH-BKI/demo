import{E,g,h as w,a as T,b as V,c as O,e as j,f as B}from"./index-atDm_1ui.js";let A=!1,P=!1,h=!1,L=null;function p(e,t){return e==null||t===null||t===void 0?"N/A":`${e} × ${t}`}function M(e){const t=o=>o??"N/A";return[`Orientation: ${t(e?.orientation)}`,`Viewport: ${p(e?.viewportWidth,e?.viewportHeight)}`,`Canvas: ${p(e?.canvasWidth,e?.canvasHeight)}`,`Aspect ratio: ${t(e?.aspectRatio)}`,`Canvas aspect ratio: ${t(e?.canvasAspectRatio)}`,`Device pixel ratio: ${t(e?.devicePixelRatio)}`].join(`
