...
vec3 cameraForward,
float cameraNearPlane) {float depth=textureLod(depthTexture,uv,0.).r;return depth>=1. ? 0. : reconstructDistanceFromCamera(depth,cameraRayDirection,cameraForward,cameraNearPlane);}`;h.IncludesShadersStore[X]||(h.IncludesShadersStore[X]=Fe);const J="atmosphereFunctions",He=`#include<intersectionFunctions>
...
#endif
`;h.IncludesShadersStore[J]||(h.IncludesShadersStore[J]=He);const Q="diffuseSkyIrradiancePixelShader",Ve=`precision highp float;const float DiffuseSkyIrradianceLutSampleCount=32.0;
